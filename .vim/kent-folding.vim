...
command -range Foldcreateauto call <SID>CreateFoldAutoTitle(<line1>, <line2>)
...
"{{{  function <SID>CreateFoldAutoTitle(startsel, endsel)
" Function to create a fold
" Arguments: a:startsel is the first line of the selection
"            a:endsel is the last line of the selection
function <SID>CreateFoldAutoTitle(startsel, endsel)
  ...
  " Add opener line
  call setline(fcstart , getline(fcstart) . ' ' . GetComment(&filetype, 0) . GetFoldMarker(0, 0) . GetComment(&filetype, 1))
